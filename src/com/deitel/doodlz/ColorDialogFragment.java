...
public class ColorDialogFragment extends DialogFragment
{
   ...
   public Dialog onCreateDialog(Bundle bundle)
   {
      ...
      View doodleFragmentView = getActivity().getLayoutInflater().inflate(R.layout.fragment_doodle, null);
      ...
      doodleView = doodleFragmentView.findViewById(R.id.doodleView);
